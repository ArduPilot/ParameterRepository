...
## RTUN_DOUBLE_TIME: Rover Quicktune doubling time
...
## RTUN_PD_GAINMARG: Rover Quicktune P and D gain margin

Reduction in P and D gain after oscillation detected. Raise this number to get a more conservative tune

- Range: 20 90

- Units: %

## RTUN_OSC_SMAX: Rover Quicktune oscillation rate threshold

Threshold for oscillation detection. A lower value will lead to a more conservative tune.

- Range: 1 10

## RTUN_SPD_P_MAX: Rover Quicktune Speed P max

Maximum value for speed P gain

- Range: 0.1 10

## RTUN_SPD_D_MAX: Rover Quicktune Speed D max

Maximum value for speed D gain

- Range: 0.001 1

## RTUN_PI_RATIO: Rover Quicktune PI ratio

Ratio between P and I gains. Raise this to get a lower I gain, 0 to disable
...
## RTUN_FF_GAINMARG: Rover Quicktune Steering Rate FeedForward gain margin

Reduction in Steering Turn Rate FF gain from measured outputs and response. Raise this number to get a more conservative tune
...
## RCRC_PROTOCOLS: RC protocols enabled
...
## RCRC_MSGRATE: DroneCAN RC Message rate
...
## RCRC1_PORT_OPTIONS: RC input port serial options
