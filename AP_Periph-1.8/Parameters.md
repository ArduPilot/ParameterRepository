...
## AUTOLAND_ENABLE: AUTOLAND ENABLE

enable AUTOLAND script action
...
## AUTOLAND_WP_ALT: Final approach waypoint alt
...
## AUTOLAND_WP_DIST: Final approach waypoint distance

Distance from landng point (HOME) to final approach waypoint created by script in the opposite direction of initial takeoff
