...
## ARSPD3_AUTOCAL: Automatic airspeed ratio calibration
...
## ARSPD4_AUTOCAL: Automatic airspeed ratio calibration
...
## ARSPD5_AUTOCAL: Automatic airspeed ratio calibration
...
## ARSPD6_AUTOCAL: Automatic airspeed ratio calibration
...
## SIM_BATT_VOLTAGE: Simulated battery resting voltage

*Note: This parameter is for advanced users*

Simulated battery resting voltage (no load sag). Defaults to and clipped to the battery model's maximum voltage. Changes re-initialize the state of charge, and values below the maximum indicate a partially-charged battery. For batteries with unlimited capacity, see `SIM_BATT_CAP_AH`. Value ignored when receiving battery state updates from an external source.
...
Frequency of vibration applied to IMU readings in SITL (X-axis)

- Units: Hz

## SIM_VIB_FREQ_Y: Vibration frequency

Frequency of vibration applied to IMU readings in SITL (Y-axis)

- Units: Hz

## SIM_VIB_FREQ_Z: Vibration frequency

Frequency of vibration applied to IMU readings in SITL (Z-axis)
...
Simulates distortion of magnetometer readings caused by motor current (X-axis)
...
Simulates distortion of magnetometer readings caused by motor current (Y-axis)
...
Simulates distortion of magnetometer readings caused by motor current (Z-axis)
...
Magnetometer offset injected into the simulation (X-axis)

## SIM_MAG1_OFS_Y: Magnetometer offset applied to SITL

*Note: This parameter is for advanced users*

Magnetometer offset injected into the simulation (Y-axis)

## SIM_MAG1_OFS_Z: Magnetometer offset applied to SITL

*Note: This parameter is for advanced users*

Magnetometer offset injected into the simulation (Z-axis)

## SIM_MAG_ALY_X: NED anomaly vector at ground level

*Note: This parameter is for advanced users*

Simulates localized magnetic field distortions at ground level that decays with altitude. (X-axis)
...
Simulates localized magnetic field distortions at ground level that decays with altitude. (Y-axis)
...
Simulates localized magnetic field distortions at ground level that decays with altitude. (Z-axis)
...
DIA_X in the magnetometer soft-iron calibration matrix: [[DIA_X, ODI_X, ODI_Y], [ODI_X, DIA_Y, ODI_Z], [ODI_Y, ODI_Z, DIA_Z]]

## SIM_MAG1_DIA_Y: Magnetometer soft-iron diagonal Y component

*Note: This parameter is for advanced users*

DIA_Y in the magnetometer soft-iron calibration matrix: [[DIA_X, ODI_X, ODI_Y], [ODI_X, DIA_Y, ODI_Z], [ODI_Y, ODI_Z, DIA_Z]]

## SIM_MAG1_DIA_Z: Magnetometer soft-iron diagonal Z component

*Note: This parameter is for advanced users*

DIA_Z in the magnetometer soft-iron calibration matrix: [[DIA_X, ODI_X, ODI_Y], [ODI_X, DIA_Y, ODI_Z], [ODI_Y, ODI_Z, DIA_Z]]

## SIM_MAG1_ODI_X: Magnetometer soft-iron off-diagonal X component

*Note: This parameter is for advanced users*

ODI_X in the magnetometer soft-iron calibration matrix: [[DIA_X, ODI_X, ODI_Y], [ODI_X, DIA_Y, ODI_Z], [ODI_Y, ODI_Z, DIA_Z]]

## SIM_MAG1_ODI_Y: Magnetometer soft-iron off-diagonal Y component

*Note: This parameter is for advanced users*

ODI_Y in the magnetometer soft-iron calibration matrix: [[DIA_X, ODI_X, ODI_Y], [ODI_X, DIA_Y, ODI_Z], [ODI_Y, ODI_Z, DIA_Z]]

## SIM_MAG1_ODI_Z: Magnetometer soft-iron off-diagonal Z component

*Note: This parameter is for advanced users*

ODI_Z in the magnetometer soft-iron calibration matrix: [[DIA_X, ODI_X, ODI_Y], [ODI_X, DIA_Y, ODI_Z], [ODI_Y, ODI_Z, DIA_Z]]
...
Enable the injection of temperature disturbance to the accelerometer and gyroscope data to simulate temperature calibration
...
This is the applied simulated acceleration to the 1st accelerometer (X-axis)

## SIM_IMUT1_ACC1_Y: Applied simulated acceleration to accelerometer

*Note: This parameter is for advanced users*

This is the applied simulated acceleration to the 1st accelerometer (Y-axis)

## SIM_IMUT1_ACC1_Z: Applied simulated acceleration to accelerometer

*Note: This parameter is for advanced users*

This is the applied simulated acceleration to the 1st accelerometer (Z-axis)

## SIM_IMUT1_ACC2_X: Applied simulated acceleration to accelerometer

*Note: This parameter is for advanced users*

This is the applied simulated acceleration to the 2nd accelerometer (X-axis)

## SIM_IMUT1_ACC2_Y: Applied simulated acceleration to accelerometer

*Note: This parameter is for advanced users*

This is the applied simulated acceleration to the 2nd accelerometer (Y-axis)

## SIM_IMUT1_ACC2_Z: Applied simulated acceleration to accelerometer

*Note: This parameter is for advanced users*

This is the applied simulated acceleration to the 2nd accelerometer (Z-axis)

## SIM_IMUT1_ACC3_X: Applied simulated acceleration to accelerometer

*Note: This parameter is for advanced users*

This is the applied simulated acceleration to the 3rd accelerometer (X-axis)

## SIM_IMUT1_ACC3_Y: Applied simulated acceleration to accelerometer

*Note: This parameter is for advanced users*

This is the applied simulated acceleration to the 3rd accelerometer (Y-axis)

## SIM_IMUT1_ACC3_Z: Applied simulated acceleration to accelerometer

*Note: This parameter is for advanced users*

This is the applied simulated acceleration to the 3rd accelerometer (Z-axis)

## SIM_IMUT1_GYR1_X: Applied simulated angular rate to gyroscope

*Note: This parameter is for advanced users*

This is the applied simulated angular rate to the 1st gyroscope (X-axis)

## SIM_IMUT1_GYR1_Y: Applied simulated angular rate to gyroscope

*Note: This parameter is for advanced users*

This is the applied simulated angular rate to the 1st gyroscope (Y-axis)

## SIM_IMUT1_GYR1_Z: Applied simulated angular rate to gyroscope

*Note: This parameter is for advanced users*

This is the applied simulated angular rate to the 1st gyroscope (Z-axis)

## SIM_IMUT1_GYR2_X: Applied simulated angular rate to gyroscope

*Note: This parameter is for advanced users*

This is the applied simulated angular rate to the 2nd gyroscope (X-axis)

## SIM_IMUT1_GYR2_Y: Applied simulated angular rate to gyroscope

*Note: This parameter is for advanced users*

This is the applied simulated angular rate to the 2nd gyroscope (Y-axis)

## SIM_IMUT1_GYR2_Z: Applied simulated angular rate to gyroscope

*Note: This parameter is for advanced users*

This is the applied simulated angular rate to the 2nd gyroscope (Z-axis)

## SIM_IMUT1_GYR3_X: Applied simulated angular rate to gyroscope

*Note: This parameter is for advanced users*

This is the applied simulated angular rate to the 3rd gyroscope (X-axis)

## SIM_IMUT1_GYR3_Y: Applied simulated angular rate to gyroscope

*Note: This parameter is for advanced users*

This is the applied simulated angular rate to the 3rd gyroscope (Y-axis)

## SIM_IMUT1_GYR3_Z: Applied simulated angular rate to gyroscope

*Note: This parameter is for advanced users*

This is the applied simulated angular rate to the 3rd gyroscope (Z-axis)

## SIM_IMUT1_TMAX: Simulated temperature calibration max

*Note: This parameter is for advanced users*

The maximum simulated temperature that the calibration is valid for. This must be at least 10 degrees above TMIN for calibration
...
The minimum simulated temperature that the calibration is valid for
...
## SIM_SONAR_OFFSET: Sonar measurement offset.
...
Allow setting which fix type (only some GPS's supported); matches AP_GPS_FixType
...
- Bitmask: 0: Reset position on startup, 1: Swap first 4 and last 4 servos (for quadplane testing), 2: Demix heli servos and send roll/pitch/collective/yaw, 3: Don't print frame rate stats, 4: Don't log Dt stats

## SIM_RFL_SAMPLEHZ: FlightAxis IMU synthetic sample rate

*Note: This parameter is for advanced users*

FlightAxis IMU synthetic sample rate
